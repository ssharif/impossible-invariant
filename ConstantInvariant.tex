...
In order to guarantee that the $q$-expansion of $\psimod^*(f)$ has a non-zero coefficient,
we establish some results about matrices.

We begin with some density results for matrices.
