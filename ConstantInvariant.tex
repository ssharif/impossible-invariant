...
\begin{proof}[Proof of Theorem~\ref{thm:curves-dense}]
  ...
  Let $f$ be a Siegel modular function on $\ag$, viewed as a global section of the structure sheaf. Recall that $f$ admits a $q$-expansion of the form $f = \sum_Q c_Q q^{\tr(Q)}$ where $Q$ ranges over all symmetric half-integral positive semi-definite matrices $\mathfrak{Q}$ \cite[Prop. V.1.5]{faltings1990degeneration}.
