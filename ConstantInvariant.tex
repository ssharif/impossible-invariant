...
\begin{lemma}\label{lem:unique-minimizer}
  Let $S$ be any nonempty subset of symmetric, positive semi-definite, half-integral $g \times g$ matrices $Q$. Then there exists an open cone of positive definite, real, symmetric, $g \times g$ matrices $A$ such that $\displaystyle\min_{Q \in S}\tr(AQ)$ is achieved by a unique $Q$.
\end{lemma}
\begin{proof}
