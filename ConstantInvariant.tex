...
In this section we work over $\C$. Suppose that $A$ is a symmetric, positive definite integer matrix. Let $N = \det A$. Let $\hh$ denote the complex upper half plane and let $\hh_g$ denote the degree $g$ Siegel upper half space. Define %a map 
\[
