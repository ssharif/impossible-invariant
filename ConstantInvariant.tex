...
\begin{lemma}\label{lemma:order-ideal-subgroup}
  Let $E$ be a CM elliptic curve. If $H = H(I)$ is an ideal subgroup of $E$, then $\# H = [\End(E):I]$.
\end{lemma}
\begin{proof}
  This is~\cite[Prop. 23]{kani2011products}.
\end{proof}
