...
Suppose $(B,\mu) \in \agd$.  
 ...
 $H$ is (maximal) isotropic with respect to the perfect skew-symmetric pairing %$e^\mu$ 
  ...
  By \cite[Proposition 1]{mumford1966}, the abelian variety $A$ has a principal polarization $\lambda$ such that $\rho^*(\lambda) = \mu$. There is then an appropriate choice of level structure $L$ such that, by \cite[Proposition 1]{mumford1966}, $\pi_D(A, \lambda, L) \cong (B,\mu)$, so $\pi_D$ is surjective. \textcolor{red}{How do we construct $L$?}
