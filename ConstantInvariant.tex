...
Since the morphism $\pi_D$ is surjective, %we have $(\pi_D\times\pi_D)(\mg(k)) = \sgd(k)$.
  Proposition~\ref{prop:whatever} now follows from Proposition~\ref{prop:medium-isomorphic}.
\end{proof}
