...
Thus $\ker\pi_j$ is not an ideal subgroup of $E_{j-1}$, by Lemma \ref{lemma:order-ideal-subgroup}. % \cite[Prop.~23]{kani2011products}. 
  Thus by Theorem~\ref{thm:kani-20b}, we must have $[\sO_{j-1} : \sO_j] = q_j$. Thus $[\sO_K : \sO_n] = \prod_{i=1}^n q_i = q$, as required.
\end{proof}
