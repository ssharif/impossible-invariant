...
from $S_D(A_1,\lambda_1)$ to $S_D(A_2,\lambda_2)$.
  ...
  The proof proceeds as above, if we replace $\agn, \agphi, \agd$, and $\ag$ with $V, \pi_2(V), \pi_\Phi\pi_2(V)$,  and $\pi_1\pi_2(V)$, respectively, and note that the latter sets are all open since the morphisms $\pi_2, \pi_1, \pi_\Phi$ are finite and ???
