...
In Prop.~\ref{prop:psimod-over-c} below we obtain a more concrete characterization of $\psimod$ over $\C$. For another viewpoint on the maps $\psimod$, see \cite[p. 19 et seq.]{rains}. As we shall see in Lemma~\ref{lem:psimod-weakly-isomorphic-to-product}, the abelian variety $B$ is weakly isomorphic to a product of elliptic curves. 
