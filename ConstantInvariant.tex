...
\begin{lemma}\label{lem:lim-degree}
  Let $\ell$ be a prime not equal to the characteristic of the base. Suppose $A,A' \in \detl$, $\det(A) = \ell^n$, and $\det(A') = \ell^m$.
...
{NOTE: There is a notation conflict here, since $A$ means something else in Theorem \ref{thm:arbit-char}.)
