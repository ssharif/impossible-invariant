...
%  \]
 ...
 Since $\Lambda \subset \Lambda_A$, there is a natural isogeny
  ...
  \]
  This is the same isogeny $\rho_A$ as in the proof of Lemma \ref{lem:psimod-weakly-isomorphic-to-product}; i.e., it is the natural isogeny $E^g \to E^g$ induced by the matrix $A$. Then
\[
