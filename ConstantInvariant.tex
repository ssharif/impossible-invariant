...
% \]
Let $\sg(R) = \{(A,B) \in (\ag \times \ag)(R) | A \approx B\}$.
...
\begin{theorem}
  Suppose that $k$ is a finite field. Let $f: \ao^g \to X$ be a morphism of $k$-schemes. If $f(A) = f(B)$ whenever $A \approx B$, then $f$ is constant.
\end{theorem}
