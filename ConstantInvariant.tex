...
\begin{proof}
  For the first claim, we have that $\lambda_A = \pi^\vee \circ \lambda \circ \pi$, and hence $\deg(\lambda_A) = \deg(\pi)^2 \cdot \deg(\lambda)$. Therefore $\lambda$ is a principal polarization.
