...
from $S_D(A_1,\lambda_1)$ to $S_D(A_2,\lambda_2)$.
  ...
  Suppose now that $f$ is a rational map. Let $U \subseteq \agd$ be the domain of definition of $f$ and let $U' = (\pi_\Phi\pi_2)^{-1}(U)$. Let $V = \displaystyle\bigcap_{g \in G} g(U')$ that is, $V$ is the largest Galois-invariant subset of $\agn$ containing $U'$. 
