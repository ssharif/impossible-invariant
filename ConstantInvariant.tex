...
\begin{proof}[Proof of Corollary~\ref{cor:agn}]
  ...
  Since $\pi((A,L)) = A$, we have $f_G(A_1) = f_G(A_2)$ whenever $A_1 \approx A_2$ with $A_1,A_2 \in U$. By Theorem~\ref{thm:invariant-c-constant}, $f_G$ is constant. It follows that $f$ is constant.
\end{proof}
