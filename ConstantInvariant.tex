...
\begin{proof}
  ...
  By hypothesis, $\sO$ has no ideal of norm $c$. Hence $\ker\varphi$ is not an ideal subgroup. So by Lemma~\ref{lem:ker-idl}\textcolor{red}{TODO: cite Kani theorem 20(b)}, $\sO' \subsetneq \sO$. Then by above, we have that that $[\sO : \sO'] = c$.
\end{proof}
