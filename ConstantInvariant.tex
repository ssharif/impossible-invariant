...
\begin{lemma}\label{lem:K-exists}
  Suppose $\ell$ is a prime, $g$ is a positive integer, and  $K$ is an imaginary quadratic field such that $\sO_K^\times = \{\pm 1\}$ and $\ell$ splits into principal primes $\alpha\sO_K \cdot \overline{\alpha}\sO_K$ with $\alpha\in \sO_K$.
%  \begin{enumerate}
%    \item $\sO_K^\times = \{\pm 1\}$,
